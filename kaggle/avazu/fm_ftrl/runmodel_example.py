...
trainingFile = "/home/wangrc/data/avazu/train.csv"
...
test = '/home/wangrc/data/avazu/test.csv'
submission = 'submission_ftrl_fm.csv'
with open(submission, 'w') as outfile:
    outfile.write('id,click\n')
    for t, date, ID, x, y in data(test, D,hashSalt):
        p = learner.predict(x)
        outfile.write('%s,%s\n' % (ID, str(p)))
print('finished...')
