...
# A, paths
train = '/home/wangrc/data/avazu/train.csv'               # path to training file
test = '/home/wangrc/data/avazu/test.csv'                 # path to testing file
...
for e in range(epoch):
    ...
    for t, date, ID, x, y in data(train, D):  # data is a generator
        ...
        if t % 500000 == 0 and t > 1:
            print(' %s\tencountered: %d\tcurrent logloss: %.8f' % (
